...
public class RegistroHuesped extends JFrame {
    ...
    public RegistroHuesped() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(RegistroHuesped.class.getResource("/org/dataindev/views/imagenes/lOGO-50PX.png")));
        ...
        txtFechaN.getCalendarButton().setIcon(new ImageIcon(RegistroHuesped.class.getResource("/org/dataindev/views/imagenes/icon-reservas.png")));
        ...
        imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/org/dataindev/views/imagenes/registro.png")));

        JLabel logo = new JLabel("");
        logo.setBounds(194, 39, 104, 107);
        panel.add(logo);
        logo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/org/dataindev/views/imagenes/Ha-100px.png")));
